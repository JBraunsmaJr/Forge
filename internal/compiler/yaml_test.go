...
`
	...
	// run: shorthand should expand to sh -c
...
// compileYAML is a test helper that writes YAML to a temp file and compiles it.
func compileYAML(t *testing.T, content string) (*struct {
	...
	// Write raw YAML directly — Compile detects the .yml extension automatically.
